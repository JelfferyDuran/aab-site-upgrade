...
import { getAllProductSlugs, getProductBySlug, searchProducts, products } from "@/lib/data";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://wa.me/12019897108?text=Hi! I'm interested in: ${encodeURIComponent(title)}"
                  target="_blank"

...
export const metadata: Metadata = {
  title: "Products",
  description:
    "Browse unique vintage, repurposed, handcrafted, and home decor finds from All Aspects at the Barn.",
};
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <GlassPanel className="mx-auto max-w-3xl px-6 py-9 sm:px-12 sm:py-12">
            ...
            <p className="text-lg sm:text-xl text-stone-700 max-w-2xl mx-auto">
              Browse {productCount.toLocaleString()} unique finds — from vintage furniture to handcrafted goods.
            </p>
          </GlassPanel>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {findsData.map((img) => (
                <div
                  key={img.src}
                  className="relative aspect-square rounded-xl overflow-hidden shadow-md bg-[rgb(249_240_226)] transition-transform duration-300 hover:-translate-y-1"
                >
                  <Image
                    src={img.src}
                    alt={img.alt}

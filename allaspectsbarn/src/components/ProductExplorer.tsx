  ...
  return (
    <>
      <div className="max-w-2xl mx-auto mt-8 px-4 sm:px-6">
        ...
        <p className="mt-3 min-h-6 text-sm text-gray-600" aria-live="polite">
          {loading
            ? "Searching…"
            : query.trim()
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {catalog.items.length > 0 ? (
            ...
            <div className="py-16 text-center">
              <h2 className="text-2xl font-semibold text-gray-900">No matching products</h2>
              <p className="mt-2 text-gray-600">Try a broader word or clear the search.</p>
            </div>
          )}
          ...
          {catalog.totalPages > 1 && (
            <nav className="mt-12 flex justify-center items-center gap-2" aria-label="Product pages">
              <button
                type="button"
                onClick={() => void loadPage(catalog.page - 1, query)}

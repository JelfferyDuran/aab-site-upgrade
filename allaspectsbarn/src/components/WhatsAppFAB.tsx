  ...
  return (
    visible && (
      <a
        ...
        className="aaf-fab fixed bottom-6 right-6 z-[var(--z-fab)] flex items-center justify-center w-14 h-14 rounded-full bg-[#435298] text-white shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-300"
      >
